                 ...
                 double *mem_footprint)
{
    ...
    (*mem_footprint) += (matrix->tilem + 1) * sizeof(int);
    ...
    (*mem_footprint) += tilenum * sizeof(int) + 
                        (tilenum + 1) * sizeof(int) +
                        (tilenum * BLOCK_SIZE) * sizeof(unsigned char);
    ...
    (*mem_footprint) += tilenum * sizeof(char) + 
                        (tilenum + 1) * sizeof(int);
    ...
    memset(matrix->new_coocount, 0, (tilenum + 1) * sizeof(int));
     ...
     (*mem_footprint) += (tilenum + 1) * sizeof(int) + 
                         (tilenum + 1) * sizeof(int) + 
                         tilenum * sizeof(char) + 
                         (tilenum + 1) * sizeof(int) + 
                         (tilenum + 1) * sizeof(int) + 
    ...
    memset(matrix->csr_compressedIdx, 0, (compressed_csr_size) * sizeof(unsigned char));
     ...
     (*mem_footprint) += matrix->csrsize * sizeof(MAT_VAL_TYPE) + 
                         (matrix->csrptrlen) * sizeof(unsigned char) +
                         (compressed_csr_size) * sizeof(unsigned char);                   
    ...
    (*mem_footprint) += (matrix->coosize) * sizeof(MAT_VAL_TYPE) +
                        (matrix->coosize) * sizeof(unsigned char);
    ...
    (*mem_footprint) += (matrix->ellsize) * sizeof(MAT_VAL_TYPE) +
                        ell_compressed_size * sizeof(unsigned char);
    ...
    memset(matrix->hybIdx, 0, (hyb_compressed_size + matrix->hybcoosize) * sizeof(unsigned char));
     ...
     (*mem_footprint) += (matrix->hybellsize + matrix->hybcoosize) * sizeof(MAT_VAL_TYPE) +
                         (hyb_compressed_size + matrix->hybcoosize) * sizeof(unsigned char);
    ...
    (*mem_footprint) += matrix->dnssize * sizeof(MAT_VAL_TYPE);
    ...
    (*mem_footprint)  += (matrix->dnsrowsize) * sizeof(MAT_VAL_TYPE) +
                         matrix->dnsrowptr[tilenum] * sizeof(char);
    // dnscol
    ...
    (*mem_footprint) += (matrix->dnscolsize) * sizeof(MAT_VAL_TYPE) +
                        matrix->dnscolptr[tilenum] * sizeof(char);
    ...
    (*mem_footprint) += matrix->coototal * sizeof(MAT_VAL_TYPE) +
                        (matrix->coototal) * sizeof(int) + 
                        (matrix->coototal) * sizeof(int);

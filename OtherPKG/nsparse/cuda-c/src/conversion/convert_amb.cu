                           ...
                           int M, int pad_M, int group_num_col)
{
    ...
    cudaMalloc((void **)&d_group_seg, sizeof(int) * nz);
    cudaMalloc((void **)&d_offset, sizeof(int) * nz);
                       ...
                       int block_size, int *c_nnz)
{
    ...
    cudaMemcpy(&r_size, d_blocked_cl + (c_size - 1), sizeof(unsigned int), cudaMemcpyDeviceToHost);

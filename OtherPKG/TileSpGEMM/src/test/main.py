...
def spgemm():
    ...
    csv_path = f"dist/{current_platform}-spgemm-tilespgemm.csv"
    ...
    start_framework("spgemm", ls, odf, csv_path, '-d', device, '-aat', 0)
...
def samples():
    ...
    csv_path = f"dist/{current_platform}-spgemm-tilespgemm-representative.csv"

...
__device__ __inline__ void st_gbl_ans(const double *ans_gpu, double answer)
{
...
__device__ __inline__ double ld_gbl_double(const double *val) {
...
__device__ __inline__ void atomic_fadd(double *adr, double val)
{
